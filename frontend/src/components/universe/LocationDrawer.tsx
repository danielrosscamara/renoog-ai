...
import { X, Compass, Eye, ArrowRight, MapPin, Users, Sparkles, CheckCircle2 } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 id="location-drawer-title" className="text-sm font-bold text-white tracking-tight">
                Locations & Room Navigator
              </h2>
              <p className="text-[11px] text-zinc-400">
                {locations.length} Spatial Rooms Discovered
              </p>
            </div>
          </div>
              ...
              <div className="p-4 rounded-2xl bg-amber-500/5 border border-amber-500/20 space-y-3">
                ...
                <div className="pt-2 border-t border-amber-500/15 flex items-center justify-between">
                  <span className="text-[11px] font-medium text-zinc-400 flex items-center gap-1.5">
                    ...
                    Occupants ({getLocationOccupants(currentPhysicalRoom.id).length})
                  </span>

                  <div className="flex items-center -space-x-2">
                    {getLocationOccupants(currentPhysicalRoom.id).map((member: UniverseMember) => (
                      <img
                        key={member.id}
                        src={
                          member.avatar_url ||
                ...
                {otherRooms.map((room: UniverseLocation) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* Live Occupants Multi-Avatar Stack */}
                      <div className="py-2.5 border-y border-white/5 flex items-center justify-between my-2.5">
