...
export const HomeHub: React.FC<HomeHubProps> = ({
  ...
  return (
    <div className="relative flex flex-col flex-1 h-full overflow-y-auto bg-zinc-950 text-zinc-100 p-6 md:p-10">
      ...
      {/* Top Header Bar */}
      <div className="relative z-10 flex items-center justify-between pb-8 border-b border-zinc-800/80">
        <div>
      ...
      <div className="relative z-10 my-8">
        ...
        <p className="text-sm text-zinc-400 mt-1 max-w-2xl">
          Your active world simulation state is preserved. Explore companion cards, configure world lorebooks, or step directly into an active Universe.
        </p>
      </div>
